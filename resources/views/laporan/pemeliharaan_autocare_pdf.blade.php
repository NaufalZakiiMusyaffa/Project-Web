...
<head>
  ...
  <title>Laporan Pengajuan Aset Autocare</title>
</head>

<body>
  <img src="{{public_path('images/laporan_pengajuan/asset_header.png')}}" style="max-width: 100%">

  <h4 class="center"><b>FORMULIR PERBAIKAN ASET AUTOCARE</b></h4>
  ...
  <table>
    ...
    <tr>
        <td>
          <div class="center">
            <img height="50" width="150" src="{{ $autocare->tanda_tangan ? public_path('images/user/tanda_tangan/'.$autocare->tanda_tangan) : public_path('images/user/tanda_tangan/not-found.jpg') }}" />
          </div>
          <br>
          <b>Nama: {{$autocare->nama}}</b>
        </td>
        <td>
            <div class="center">
    ...
    <tr>
        <td><b>Jabatan: STAFF Autocare</b></td>
        <td>
