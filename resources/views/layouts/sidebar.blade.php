...
<ul class="nav">
  ...
  <li class="nav-item {{ setActive(['kategori*', 'asetit*', 'history*', 'pemeliharaan*']) }}">
    ...
    <div class="collapse {{ setShow(['kategori*', 'asetit*', 'history*', 'pemeliharaan*']) }}" id="ui-basic2">
      <ul class="nav flex-column sub-menu">
        @if(Auth::user()->level == 'manager' || Auth::user()->level == 'it')
        <li class="nav-item">
        ...
        @if(Auth::user()->level == 'manager' || Auth::user()->level == 'it')
        <li class="nav-item">
          <a class="nav-link {{ setActive(['asetit*']) }} drop-menu-item" href="{{route('asetit.index')}}">Data Aset IT</a>
        </li>
        @endif
        @if(Auth::user()->level == 'manager' || Auth::user()->level == 'it')
        <li class="nav-item">
  ...
  <li class="nav-item {{ setActive(['transaksi*']) }}">
    <a class="nav-link" href="{{route('transaksi.index')}}">
      <i class="menu-icon mdi mdi-content-copy"></i>
      <span class="menu-title">Peminjaman Aset IT</span>
    </a>
  </li>

  <li class="nav-item {{ setActive(['autocare-transaksi*']) }}">
    <a class="nav-link" href="{{route('autocare-transaksi.index')}}">
      <i class="menu-icon mdi mdi-content-copy"></i>
      <span class="menu-title">Peminjaman Aset Autocare</span>
    </a>
  </li>
  @endif
