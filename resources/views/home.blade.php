      ...
      <div class="card-body">
        <div class="row justify-content-between">
          <div class="col-3 mt-2">
            <i class="mdi mdi-radiobox-marked text-info icon-md p-0"></i>
          </div>
          <div class="col-9">
  ...
  <div class="col-xl-3 col-lg-3 col-md-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        <div class="row justify-content-between">
          <div class="col-3 mt-2">
            <i class="mdi mdi-account-location text-primary icon-md p-0"></i>
          </div>
          <div class="col-9">
  ...
  <div class="col-xl-3 col-lg-3 col-md-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        <div class="row justify-content-between">
          <div class="col-3 mt-2">
            <i class="mdi mdi-car text-primary icon-md p-0"></i>
          </div>
          <div class="col-9">
  ...
  <div class="col-xl-3 col-lg-3 col-md-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        <div class="row justify-content-between">
          <div class="col-3 mt-2">
            <i class="mdi mdi-archive text-danger icon-md p-0"></i>
          </div>
          <div class="col-9">
