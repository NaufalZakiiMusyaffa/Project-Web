...
<form action="{{ route('autocare-maintenance.update', $data->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row">
                                <p for="kode_aset" class="p-2">Kode Aset &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</p>
                                    <div class="p-2">
                                    <p><b>{{ $data->asetac->kode_aset }}</b></p>
                                    </div>
                            </div>

                            <div class="d-flex flex-row">
                                <p for="nama_aset" class="p-2">Nama Kendaraan &nbsp;:</p>
                                    <div class="p-2">
                                    <p><b>{{ $data->asetac->nama_kendaraan }}</b></p>
                                    </div>
                            </div>
                                        ...
                                        <div class="col-sm-6 mt-2">
                                            <div class="row">
                                                ...
                                                @elseif($data->status == 2)
                                                    <div class="col-md-4">
                                                        <a class="btn btn-success fa fa-print" href="{{ route('pemeliharaanac.pdf', $data->id) }}">&nbsp;&nbsp;Print</a>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-sm-4 mt-2">
                                            <a href="{{route('autocare-maintenance.index')}}" class="btn btn-light pull-right">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                        </div>
