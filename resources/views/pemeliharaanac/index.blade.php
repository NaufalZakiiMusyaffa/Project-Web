...
<div class="row">
  ...
  <div class="col-lg-2">
    <a href="{{ route('autocare-maintenance.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i> Ajukan Pemeliharaan</a>
  </div>
  @endif
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if(Auth::user()->level == 'manager')
                  @if($data->status == '1')
                    <a class="badge badge-primary fa fa-eye" href="{{ route('autocare-maintenance.show', $data->id) }}">&nbsp;&nbsp;Lihat Detail Pengajuan</a>
                  </form>
                  @endif
                  @endif
                </td>
          ...
          <table class="table table-striped" id="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if($data->status == '2')
                    <a class="badge badge-success fa fa-print" href="{{ route('autocare-maintenance.show', $data->id) }}">&nbsp;&nbsp;Print</a>
                  </form>
                  @endif
                </td>
              </tr>
