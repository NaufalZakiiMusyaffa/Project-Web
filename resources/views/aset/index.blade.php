...
<div class="row">
  ...
  <div class="col-lg-8">
    <a href="{{ route('asetit.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i> Tambah Data Aset</a>
  </div>
  @endif
  <div class="col-lg-12">
                ...
                <td>
                  <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                            <a class="dropdown-item" href="{{route('asetit.show', $data->id)}}" style="color:blue"> Lihat Data </a>
                            @if(Auth::user()->level == 'it' && $data->status_aset !== 'Sedang dipinjam' )
                            <a class="dropdown-item" href="{{route('asetit.edit', $data->id)}}" style="color:green"> Ubah Data </a>
                            <form action="{{ route('asetit.destroy', $data->id) }}" class="pull-left"  method="post">
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
