...
<form action="{{ route('asetit.update', $data->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="row">
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ubah Data Aset <b>[{{$data->nama_aset}}]</b> </h4>
                                ...
                                <div class="form-group col-md-6{{ $errors->has('nama_aset') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="nama_aset" type="text" class="form-control" name="nama_aset" value="{{ $data->nama_aset }}" required>
                                ...
                                <div class="form-group col-md-6{{ $errors->has('spesifikasi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="5" id="spesifikasi" name="spesifikasi" required>{{ $data->spesifikasi }}</textarea>
                                ...
                                <div class="form-group col-md-2{{ $errors->has('harga_beli') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="harga_beli" type="number" maxlength="11" class="form-control" name="harga_beli" value="{{ $data->harga_beli }}">
                                ...
                                <div class="form-group col-md-2{{ $errors->has('tgl_beli') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="tgl_beli" type="date" class="form-control" name="tgl_beli" value="{{ $data->tgl_beli }}">
                                ...
                                <div class="form-group col-md-2{{ $errors->has('garansi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="garansi" type="date" class="form-control" name="garansi" value="{{ $data->garansi }}">
                                ...
                                <div class="form-group col-md-6{{ $errors->has('toko_beli') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="toko_beli" type="text" class="form-control" name="toko_beli" value="{{ $data->toko_beli }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <img width="300" height="200" src="{{ $data->gambar ? asset('images/aset/'.$data->gambar) : asset('images/user/tanda_tangan/not-found.jpg') }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-sm-4 mt-2">
                                            <a href="{{route('asetit.index')}}" class="btn btn-light pull-right">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                        </div>
