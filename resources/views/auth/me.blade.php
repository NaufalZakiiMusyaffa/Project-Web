                        ...
                        <form action="{{ route('karyawan.update', $data->karyawan->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <img width="400" height="200" src="{{ $data->karyawan->tanda_tangan ? asset('images/user/tanda_tangan/'.$data->karyawan->tanda_tangan) : asset('images/user/tanda_tangan/not-found.jpg') }}" />
