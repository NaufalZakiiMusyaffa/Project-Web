...
<div class="row">
  ...
  <div class="col-lg-2">
    <a href="{{ route('autocare-transaksi.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i> Tambah Peminjaman</a>
  </div>
  @endif
  <div class="col-lg-12">
              ...
              <tr>
                ...
                <td>
                  ...
                  @if(Auth::user()->level == 'autocare')
                    ...
                    @else
                      <form action="{{ route('autocare-transaksi.destroy', $data->id) }}" method="post" style="display: block;" class="text-center">
                        {{ csrf_field() }}
                        {{ method_field('delete') }}
